...
sudo -u $USER bash -c "
    ...
    #_MARK_TO_COPY_SETTINGS_INTO_FOLDER_#
    #_MARK_TO_DELETE_SETTINGS_#
...
ExecStart=/home/$USER/.rbenv/shims/bundle exec bin/delayed_job --queues=client,client_dos start RAILS_ENV=production
...
echo "Enabling and starting Bot Client service..."
sudo systemctl daemon-reload
sudo systemctl enable $SERVICE_NAME
sudo systemctl start $SERVICE_NAME

echo "Bot Client Working!"
